    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-zinc-100 dark:from-zinc-900 dark:to-black text-gray-900 dark:text-white">
      ...
      <section className="text-center py-20 px-4">
        ...
        <Link href="/onboarding/step1">
          <button className="mt-8 px-6 py-3 bg-blue-600 text-white rounded-xl shadow hover:bg-blue-700 transition">
            Start Onboarding
          </button>
        </Link>
      </section>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto px-6 py-16">
        {[
          ...
          { title: 'Trusted by Agencies & CPAs', desc: 'Referral commissions built-in with white-label control.' }
        ].map((card, i) => (
